...
title:"F A R I Z Z BOT",
body: "Free WhatsApp Bot", 
thumbnail: fs.readFileSync("./karuta/webpmobile.jpg"),
mediaType:1,
mediaUrl: 'https://www.instagram.com/aku_bukan_farizz',
sourceUrl: "https://www.instagram.com/aku_bukan_farizz"}}}, { quoted: m })
}
try {
...
url: 'https://instagram.com/aku_bukan_farizz'
}
}, {
quickReplyButton: {
displayText: 'MENU',
...
case 'command':
  let sections = [
{
title: "DAFTAR MENU F A R I Z Z BOT",
rows: [
...
listMessage :{
    ...
    buttonText: "Menu",
    footerText: `*© Powered by F A R I Z Z*`,
